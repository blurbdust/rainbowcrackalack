 ...
 */
#ifndef _DES_BITSLICE_METAL
#define _DES_BITSLICE_METAL
...
void s1(uint a1, uint a2, uint a3, uint a4, uint a5, uint a6,
        thread uint *out1, thread uint *out2, thread uint *out3, thread uint *out4)
{
...
void f1(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[8],
       in[0] ^ key[44],
       in[1] ^ key[29],
...
void f2(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[1],
       in[0] ^ key[37],
       in[1] ^ key[22],
...
void f3(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[44],
       in[0] ^ key[23],
       in[1] ^ key[8],
...
void f4(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[30],
       in[0] ^ key[9],
       in[1] ^ key[51],
...
void f5(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[16],
       in[0] ^ key[52],
       in[1] ^ key[37],
...
void f6(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[2],
       in[0] ^ key[38],
       in[1] ^ key[23],
...
void f7(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[45],
       in[0] ^ key[49],
       in[1] ^ key[9],
...
void f8(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[31],
       in[0] ^ key[35],
       in[1] ^ key[52],
...
void f9(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[49],
       in[0] ^ key[28],
       in[1] ^ key[45],
...
void f10(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[35],
       in[0] ^ key[14],
       in[1] ^ key[31],
...
void f11(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[21],
       in[0] ^ key[0],
       in[1] ^ key[42],
...
void f12(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[7],
       in[0] ^ key[43],
       in[1] ^ key[28],
...
void f13(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[50],
       in[0] ^ key[29],
       in[1] ^ key[14],
...
void f14(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[36],
       in[0] ^ key[15],
       in[1] ^ key[0],
...
void f15(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[22],
       in[0] ^ key[1],
       in[1] ^ key[43],
...
void f16(thread uint in[], thread uint key[], thread uint out[])
{
    s1(in[31] ^ key[15],
       in[0] ^ key[51],
       in[1] ^ key[36],
...
void encrypt(constant uint *in, thread uint * key, thread uint *out)
{
    uint i;
    for (i = 0; i < 64; i++) {
        out[i] = in[i];
