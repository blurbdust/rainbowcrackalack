inline void reduce_9chars(ulong index, thread unsigned int *hi4, thread ulong *lo5) {
  // Divide by multiply
  ...
  tmp    = (unsigned int) (((ulong) ((unsigned int) (index >> 32)) * 148998437) >> 28); // just right
  // tmp = (unsigned int) (((ulong) ((unsigned int) (index >> 31)) * 148998437) >> 29); // overkill
  // tmp = (unsigned int) (((ulong) ((unsigned int) (index >> 31)) * 297996874) >> 30); // overkill

  //tmp2 = index - 7737809375 * tmp;
  // 7737809375 == 3442842079 + 2**32
  tmp2 = index - (ulong) 3442842079 * tmp - ((ulong) tmp << 32);
...
inline void reduce_8chars(ulong index, thread unsigned int *hi4, thread unsigned int *lo4) {
  // Divide by multiply
  ...
  // tmp = (unsigned int) (((ulong) ((unsigned int) (index >> 26)) * 110584777) >> 27); // not enough
  tmp    = (unsigned int) (((ulong) ((unsigned int) (index >> 25)) * 110584777) >> 28); // just right
  // tmp = (unsigned int) (((ulong) ((unsigned int) (index >> 25)) * 221169555) >> 29); // overkill
...
inline void reduce_5chars(ulong index, thread unsigned int *hi2, thread unsigned int *lo3) {
  // Divide by multiply
...
inline void reduce_4chars(unsigned int index, thread unsigned int *hi2, thread unsigned int *lo2) {
  // Divide by multiply
...
inline void reduce_3chars(unsigned int index, thread unsigned char *hi1, thread unsigned int *lo2) {
  // Divide by multiply
...
inline void reduce_2chars(unsigned int index, thread unsigned char *hi1, thread unsigned char *lo2) {
  // Divide by multiply
