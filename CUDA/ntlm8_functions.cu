...
__device__ inline void index_to_plaintext_ntlm8(unsigned long long index, const char *charset, unsigned char *plaintext) {
  // divide and modulo index by 95**4
  unsigned int indexHi = (unsigned int) (index / 81450625);
  unsigned int indexLo = (unsigned int) (index - (unsigned long long) 81450625 * indexHi);
